# -*- coding: utf-8 -*-
"""
Created on Mon Jun 10 11:25:34 2019
...
class Application:
    def createMainwindow(self):
        ...
        self.dTheta=tk.IntVar(self.MainFrame,value='30')
        ...
        self.dPhi=tk.IntVar(self.MainFrame,value='30')
        ...
        self.dPol=tk.IntVar(self.MainFrame,value='10')
        ...
        self.dE=tk.IntVar(self.MainFrame,value='300')
        ...
        self.dt=tk.IntVar(self.MainFrame,value='30')
        ...
        self.dz=tk.IntVar(self.MainFrame,value='3')
    ...
    def Vscan(self):
        ...
        fig.canvas.manager.set_window_title('x:Azumith vs y:Polar (Polarisation ='+str(pol_A[0])+')')
...
#        print 'Total Average overlap :' + str(np.mean(means))
        ...
        fig4.canvas.manager.set_window_title(r'x:Azumith vs y:Theta (theta =0)')
        ...
        plt.savefig('H:/work/My Papers/2022/Birefringence invited paper/optical axis/figure4_top.png', dpi=300)
    ...
    def Zscan(self):
        ...
        theta = np.linspace(0,np.pi,dimen[0]) ##PRobably all need to be either pi or 2pi
        phi = np.linspace(0,2*np.pi,dimen[1])
        rot = np.linspace(0,np.pi,dimen[2])
        ...
        for indx in idx:
            ...
            fig1.suptitle('Populations modelling: '+xtaltype[0]+', '+r'$\theta_{d}$ = '+ str(Dp_A[0])+', ' +r'$\phi_{d}$ = '+ str(Dp_A[1]))
        ...
        for indx in idx:
            ...
            ax21.pcolor(rot,theta,efield[:,indx,:,0],vmin=0, vmax=1.0)
            ax21.set_ylabel(r'$\theta_k$')
            ax21.title.set_text(r'$E_1$')
            plt.setp(ax21,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax22  = fig2.add_subplot(3,4,2)
            ax22.pcolor(rot,theta,NS0[:,indx,:,0],vmin=0, vmax=1.0)
            ...
            ax23.pcolor(rot,theta,NS1[:,indx,:,0],vmin=0, vmax=1.0)
            ...
            ax24.pcolor(rot,theta,NS2[:,indx,:,0],vmin=0, vmax=1.0)
            ...
            ax25.pcolor(rot,theta,efield[:,indx,:,1],vmin=0, vmax=1.0)                
            ...
            ax26.pcolor(rot,theta,NS0[:,indx,:,1],vmin=0, vmax=1.0)
            ax26.title.set_text(r'$S_0$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax27  = fig2.add_subplot(3,4,7)
            ax27.pcolor(rot,theta,NS1[:,indx,:,1],vmin=0, vmax=1.0)
            ax27.title.set_text(r'$S_1$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax28  = fig2.add_subplot(3,4,8)
            ax28.pcolor(rot,theta,NS2[:,indx,:,1],vmin=0, vmax=1.0)
            ax28.title.set_text(r'$S_2$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax29  = fig2.add_subplot(3,4,9)
            ax29.pcolor(rot,theta,efield[:,indx,:,0]+efield[:,indx,:,1],vmin=0, vmax=1.0)
            ...
            ax210.pcolor(rot,theta,(NS0[:,indx,:,2]),vmin=0, vmax=1.0)
            ax210.title.set_text(r'$S_0$')
            ax210.set_xlabel(r'$\psi_k$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax211  = fig2.add_subplot(3,4,11)
            ax211.pcolor(rot,theta,(NS1[:,indx,:,2]),vmin=0, vmax=1.0)
            ax211.title.set_text(r'$S_1$')
            ax211.set_xlabel(r'$\psi_k$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            ax212  = fig2.add_subplot(3,4,12)
            ax212.pcolor(rot,theta,(NS2[:,indx,:,2]),vmin=0, vmax=1.0)
            ax212.title.set_text(r'$S_2$')
            ax212.set_xlabel(r'$\psi_k$')
            plt.setp(ax25,yticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],yticklabels=['0','',r'$\pi$/2','',r'$\pi$'],\
                 xticks=[0, np.pi/4, 2*np.pi/4, 3*np.pi/4, np.pi],xticklabels=['0','',r'$\pi$/2','',r'$\pi$'])
            fig2.suptitle('Populations modelling: '+xtaltype[0]+', '+r'$\theta_{d}$ = '+ str(Dp_A[0])+', ' +r'$\phi_{d}$ = '+ str(Dp_A[1]))
            fig2.tight_layout(pad=0.5, w_pad=0.5, h_pad=0.5)    
    ...
    def Z_energy_scan(self):
        ...
        for i in range(np.shape(E_space)[0]):
            ...
            print('('+str(i)+'/'+str(np.shape(E_space)[0])+')')
